...
-- This file contains all necessary SQL for initial database setup
-- Run this manually if you need to reset the database completely
-- ============================================================
...
-- CreateTable: Account (OAuth accounts)
...
-- CreateTable: Session (User sessions)
...
-- CreateTable: User (Application users)
...
-- CreateTable: VerificationToken (Email verification)
...
-- CreateTable: PasswordResetToken (Password reset)
...
-- CreateTable: Upload (File uploads)
